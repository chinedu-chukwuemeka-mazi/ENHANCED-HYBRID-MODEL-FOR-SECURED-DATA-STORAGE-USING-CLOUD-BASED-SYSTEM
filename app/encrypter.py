...
def Algo1_extented(filename, key1, key2):
    ...
    raw = ""
    for line in file:
        raw = raw.encode('utf-8', 'ignore') + line
...
def encrypter():
    ...
    key_1_1 = Fernet.generate_key().decode()
    key_1_2 = Fernet.generate_key().decode()
    ...
    print(key_1, key_1_1, key_1_2, key_2, key_3, key_4, nonce12, nonce13)
    secret_information = str(key_1_1)+":::::"+str(key_1_2)+":::::"+str(key_2)+":::::"+str(key_3)+":::::"+str(key_4)+":::::"+str(nonce12)+":::::"+str(nonce13)
